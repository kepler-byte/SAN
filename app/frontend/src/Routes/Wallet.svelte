...
>
  ...
  <div class="w-full mt-10">
    ...
    <div class="flex justify-between items-center mb-4">
      <h3 class="text-lg font-bold font-['LINE_Seed_Sans_TH'] text-gray-900">
        ประวัติการทำรายการ
      </h3>
      <button
        class="text-blue-600 hover:text-blue-800 text-sm font-medium font-['LINE_Seed_Sans_TH'] transition"
    ...
    {#if paymentHistory.length > 0}
      <div class="w-full px-6 py-3 bg-gray-100 rounded-lg flex items-center gap-3">
        <Wallet class="w-5 h-5 text-gray-600" />
        <div class="flex-1 flex flex-col justify-start items-start gap-1">
          <div class="text-black text-sm font-bold font-['LINE_Seed_Sans_TH'] leading-tight">
            เติมเงินด้วย TrueMoney
          </div>
          <div class="text-gray-500 text-sm font-normal font-['LINE_Seed_Sans_TH'] leading-tight">
            +{formatPoints(paymentHistory[0].points_added)} Point ({paymentHistory[0].amount_baht} บาท)
          </div>
        </div>
        <div class="text-gray-400 text-xs font-normal font-['LINE_Seed_Sans_TH'] leading-none">
          {formatThaiDate(paymentHistory[0].created_at)}
        </div>
      </div>
    {:else}
      <div class="w-full px-6 py-8 bg-gray-50 rounded-lg flex flex-col items-center gap-3">
        <Wallet class="w-8 h-8 text-gray-400" />
        <p class="text-gray-500 text-sm font-['LINE_Seed_Sans_TH'] text-center">
  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] flex flex-col">
      ...
      <div class="flex items-center justify-between p-6 border-b border-gray-200">
        ...
        <button
          class="w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center transition"
      ...
      <div class="flex-1 overflow-y-auto p-6">
        ...
        {:else if paymentHistory.length === 0}
          <div class="flex flex-col items-center justify-center py-12 text-center">
            <Wallet class="w-16 h-16 text-gray-300 mb-4" />
            <h3 class="text-lg font-semibold font-['LINE_Seed_Sans_TH'] text-gray-600 mb-2">
              ยังไม่มีประวัติการทำรายการ
            </h3>
            <p class="text-gray-500 font-['LINE_Seed_Sans_TH']">
              ...
              <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition">
                <div class="flex items-start justify-between">
                  <div class="flex items-start gap-3">
                    ...
                    <!-- Content -->
                    <div class="flex-1">
                      <h4 class="font-semibold font-['LINE_Seed_Sans_TH'] text-gray-900">
                        เติมเงินด้วย TrueMoney Wallet
                      </h4>
                      <p class="text-sm text-gray-600 font-['LINE_Seed_Sans_TH'] mt-1">
                        +{formatPoints(payment.points_added)} Point ({payment.amount_baht} บาท)
                      </p>
                      <p class="text-xs text-gray-500 font-['LINE_Seed_Sans_TH'] mt-2">
                  ...
                  <div class="text-right">
                    <div class="inline-flex items-center px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium font-['LINE_Seed_Sans_TH'] mb-2">
                      สำเร็จ
                    </div>
                    <p class="text-xs text-gray-500 font-['LINE_Seed_Sans_TH']">
      ...
      <div class="p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
        <div class="flex items-center justify-between text-sm font-['LINE_Seed_Sans_TH']">
